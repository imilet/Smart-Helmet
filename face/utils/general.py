...
from face.utils.google_utils import gsutil_getsize
from face.utils.metrics import fitness
from face.utils.torch_utils import init_torch_seeds
...
def strip_optimizer(f='weights/best.pt', s=''):  # from face.utils.general import *; strip_optimizer()
