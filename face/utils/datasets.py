...
from face.utils.general import xyxy2xywh, xywh2xyxy, xywhn2xyxy, clean_str
from face.utils.torch_utils import torch_distributed_zero_first
...
def extract_boxes(path='../coco128/'):  # from face.utils.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco128', weights=(0.9, 0.1, 0.0)):  # from face.utils.datasets import *; autosplit('../coco128')
