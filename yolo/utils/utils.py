...
def strip_optimizer(f='weights/best.pt'):  # from yolo.utils.utils import *; strip_optimizer()
...
def create_pretrained(f='weights/best.pt', s='weights/pretrained.pt'):  # from yolo.utils.utils import *; create_pretrained()
...
def coco_only_people(path='../coco/labels/train2017/'):  # from yolo.utils.utils import *; coco_only_people()
...
def crop_images_random(path='../images/', scale=0.50):  # from yolo.utils.utils import *; crop_images_random()
...
def coco_single_class_labels(path='../coco/labels/train2014/', label_class=43):
    # Makes single-class coco datasets. from yolo.utils.utils import *; coco_single_class_labels()
...
def kmean_anchors(path='./data/coco128.yaml', n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    """ Creates kmeans-evolved anchors from training dataset
        ...
        Usage:
            from yolo.utils.utils import *; _ = kmean_anchors()
    """
    thr = 1. / thr
...
def plot_wh_methods():  # from yolo.utils.utils import *; plot_wh_methods()
...
def plot_test_txt():  # from yolo.utils.utils import *; plot_test()
...
def plot_targets_txt():  # from yolo.utils.utils import *; plot_targets_txt()
...
def plot_study_txt(f='study.txt', x=None):  # from yolo.utils.utils import *; plot_study_txt()
...
def plot_evolution_results(hyp):  # from yolo.utils.utils import *; plot_evolution_results(hyp)
...
def plot_results_overlay(start=0, stop=0):  # from yolo.utils.utils import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket='', id=(), labels=(),
                 save_dir=''):  # from yolo.utils.utils import *; plot_results()
